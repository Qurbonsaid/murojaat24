      ...
      <DialogContent className="max-w-xl overflow-y-scroll max-h-full">
        ...
        >
          <div className="space-y-2">
            <Label htmlFor="manager-add-name">Ism-familiya *</Label>
            <Input
              id="manager-add-name"
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="manager-add-role">
          ...
          <div className="space-y-2">
            ...
            >
              <SelectTrigger id="manager-add-organization">
          ...
          <div className="space-y-2">
            <Label htmlFor="manager-add-quarter">Mahalla</Label>
            <Input
              id="manager-add-quarter"
          ...
          <div className="space-y-2">
            <Label htmlFor="manager-add-sector">Sektor</Label>
            <Input
              id="manager-add-sector"
...
export default ManagerAddUserModal;
